...
function ConfigPage({ onNavigateToInterview }) {
  /**
   * API_BASE:
   * - ถ้าตั้ง VITE_API_BASE ไว้ -> ใช้อันนั้น
  ...
  const resetQuestionPrompt = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE}/config/default/question_prompt`);
      const data = await response.json();
  ...
  const resetAnalysisPrompt = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE}/config/default/analysis_prompt`);
      const data = await response.json();
  ...
  const updateExampleQuestion = (type, index, value) => {
    setConfig((prev) => ({
      ...
      example_questions: {
        ...prev.example_questions,
        [type]: prev.example_questions[type].map((q, i) =>
          i === index ? value : q
        ),
      },
    }));
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p
              ...
              style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
            >
              ปรับแต่งการทำงานของระบบ
            </p>
          </div>
          <button
            ...
            <div className="bg-white rounded-2xl shadow-mentimeter p-8 border border-gray-200">
              <div className="mb-6">
                <h3
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#1e293b' }}
                >
                ...
                <p
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                >
                  ปรับแต่ง prompt สำหรับการสร้างคำถามจาก AI
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {['{topic}', '{previous_answer}', '{conversation_history}', '{turn}'].map(
                      (tag) => (
                        <span
                          key={tag}
                          className="px-3 py-1 rounded-xl text-xs font-mono text-white"
                          style={{
                            background:
                              'linear-gradient(135deg, #6C5CE7 0%, #0984E3 100%)',
                          }}
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.target.style.boxShadow =
                      '0 12px 28px 0 rgba(108, 92, 231, 0.25)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'translateY(0)';
                    e.target.style.boxShadow =
                      '0 8px 24px 0 rgba(108, 92, 231, 0.15), 0 4px 8px 0 rgba(0, 0, 0, 0.08)';
                  }}
                >
            ...
            <div className="bg-white rounded-2xl shadow-mentimeter p-8 border border-gray-200">
              <div className="mb-6">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                >
                  ปรับแต่ง prompt สำหรับการวิเคราะห์คำตอบและสร้าง Insights
                </p>
              </div>
              ...
              >
                <div
                  className="bg-white p-4 rounded-xl border-2 mb-4"
                  style={{ borderColor: '#e2e8f0' }}
                >
                  <div className="flex items-center gap-2 mb-3">
                    <FontAwesomeIcon
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {['{topic}', '{question}', '{answer}', '{conversation_history}'].map(
                      (tag) => (
                        <span
                          key={tag}
                          className="px-3 py-1 rounded-xl text-xs font-mono text-white"
                ...
                <p
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                >
                  Prompt นี้จะวิเคราะห์คำตอบและสร้าง Insights เพื่อใช้ในการคิดคำถามถัดไป ให้ AI
                  สามารถถามคำถามที่เกี่ยวข้องและต่อเนื่องกับคำตอบที่ได้รับ
                </p>
              </div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setConfig((prev) => ({
                    ...prev,
                    analysis_prompt: e.target.value,
                  }))
                }
                      ...
                      {questions.map((question, index) => (
                        <div key={index} className="flex gap-2">
                          <input
                            ...
                            value={question}
                            onChange={(e) =>
                              updateExampleQuestion(type, index, e.target.value)
                            }
                          ...
                          <button
                            ...
                            onMouseEnter={(e) => {
                              ...
                              e.target.style.boxShadow =
                                '0 8px 16px 0 rgba(214, 48, 49, 0.3)';
                            }}
                            onMouseLeave={(e) => {
                              e.target.style.transform = 'translateY(0)';
                              e.target.style.boxShadow =
                                '0 4px 8px 0 rgba(214, 48, 49, 0.2)';
                            }}
                          >
            ...
            <div className="bg-white rounded-2xl shadow-mentimeter p-8 border border-gray-200">
              <div className="mb-6">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                >
                  ตั้งค่าโมเดล AI และพารามิเตอร์ต่างๆ
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  >
                    Temperature (คำถาม):{' '}
                    <span className="font-bold" style={{ color: '#6C5CE7' }}>
                      {config.model_settings.temperature_question}
                    </span>
                  </label>
                  <input
                    type="range"
                    ...
                    onChange={(e) =>
                      setConfig((prev) => ({
                        ...
                        model_settings: {
                          ...prev.model_settings,
                          temperature_question: parseFloat(e.target.value),
                        },
                      }))
                    }
                ...
                <div>
                  <label
                    ...
                    style={{ fontFamily: "'Kanit', sans-serif", color: '#1e293b' }}
                  >
                    Temperature (วิเคราะห์):{' '}
                    <span className="font-bold" style={{ color: '#6C5CE7' }}>
                      {config.model_settings.temperature_analysis}
                    </span>
                  </label>
                  <input
                    type="range"
                    ...
                    onChange={(e) =>
                      setConfig((prev) => ({
                        ...
                        model_settings: {
                          ...prev.model_settings,
                          temperature_analysis: parseFloat(e.target.value),
                        },
                      }))
                    }
                    className="w-full h-2 rounded-lg appearance-none cursor-pointer"
            ...
            <div className="bg-white rounded-2xl shadow-mentimeter p-8 border border-gray-200">
              <div className="mb-6">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                >
                  ดูประวัติการสัมภาษณ์ที่จบแล้วทั้งหมด
                </p>
              </div>
              ...
              {isLoadingSessions ? (
                ...
                >
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                  >
                    การสัมภาษณ์ที่จบแล้วจะแสดงที่นี่
                  </p>
                </div>
              ) : selectedSession ? (
                <div>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <h4
                            ...
                            style={{ fontFamily: "'Kanit', sans-serif", color: '#1e293b' }}
                          >
                            {selectedSession.topic || 'ไม่ระบุหัวข้อ'}
                          </h4>
                          <p
                            className="text-xs"
                            style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                      ...
                      <div className="grid grid-cols-3 gap-4 mt-4">
                        ...
                        >
                          ...
                          <p
                            ...
                            style={{ fontFamily: "'Kanit', sans-serif", color: '#1e293b' }}
                          >
                            {formatDate(selectedSession.exportedAt)}
                          </p>
                        </div>
                      </div>
                    </div>
                          ...
                          >
                            <div className="flex items-start gap-3 mb-4">
                              ...
                              <div className="flex-1">
                                ...
                                >
                                  {qa.answer || 'ไม่มีคำตอบ'}
                                </p>
                              </div>
                            </div>
                            {qa.analysis &&
                              qa.analysis.insights &&
                              qa.analysis.insights.length > 0 && (
                                <div
                    ...
                    <div
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.boxShadow =
                          '0 4px 12px 0 rgba(108, 92, 231, 0.1)';
                        ...
                        >
                          ...
                          <div className="flex gap-4">
                            <div className="flex items-center gap-2">
                              ...
                              >
                                {session.totalQuestions || 0} คำถาม
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              <FontAwesomeIcon
                              ...
                              >
                                {session.totalInsights || 0} Insights
                              </span>
                            </div>
                          </div>
                        </div>
            ...
            <div className="bg-white rounded-2xl shadow-mentimeter p-8 border border-gray-200">
              <div className="mb-6">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Kanit', sans-serif", color: '#64748b' }}
                >
                  Export, Import หรือรีเซ็ตการตั้งค่า
                </p>
              </div>
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.transform = 'translateY(-2px)';
                    e.target.style.boxShadow =
                      '0 12px 28px 0 rgba(30, 41, 59, 0.25)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'translateY(0)';
                    e.target.style.boxShadow =
                      '0 8px 24px 0 rgba(30, 41, 59, 0.15), 0 4px 8px 0 rgba(0, 0, 0, 0.08)';
                  }}
                >
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.transform = 'translateY(-2px)';
                    e.target.style.boxShadow =
                      '0 12px 28px 0 rgba(214, 48, 49, 0.25)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'translateY(0)';
                    e.target.style.boxShadow =
                      '0 8px 24px 0 rgba(214, 48, 49, 0.15), 0 4px 8px 0 rgba(0, 0, 0, 0.08)';
                  }}
                >
                  <FontAwesomeIcon icon="fa-solid fa-rotate" className="text-sm" />
